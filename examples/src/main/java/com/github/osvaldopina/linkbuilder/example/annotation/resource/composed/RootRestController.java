...
import com.github.osvaldopina.linkbuilder.example.annotation.resource.composed.link.MyLinkDestination;
...
public class RootRestController {
    ...
    @RequestMapping("/")
    @MyLinkDestination(destination = Destionation.ROOT)
    ...
    @MyLinkDestination(destination = Destionation.DIRECT_LINK)
    ...
    @MyLinkDestination(destination = Destionation.DIRECT_LINK_TEMPLATED)
