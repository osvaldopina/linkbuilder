...
public class PathParameterVariableValueDiscover implements ParameterVariableValueDiscover {
    ...
    public PathParameterVariableValueDiscover(IntrospectionUtils instrospectionUtils) {
    ...
    public Collection<VariableValue> getVariableValues(Variables variables, MethodCall methodCall,
        ...
        String variableName = instrospectionUtils.getPathVariableName(methodCall.getMethod(), parameterIndex);
    ...
    public boolean canDiscover(MethodCall methodCall, int parameterIndex) {
        return instrospectionUtils.isPathVariableParameter(methodCall.getMethod(), parameterIndex);
    }
}
