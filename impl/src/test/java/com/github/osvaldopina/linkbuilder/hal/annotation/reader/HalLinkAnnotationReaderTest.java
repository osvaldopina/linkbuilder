...
public class HalLinkAnnotationReaderTest extends EasyMockSupport {
	...
	@Test
	public void read() {
		expect(halLinkAnnotationRetriever.getLinksAnnotation(method)).andReturn(linksAnnotation);
	...
	public void canRead_nonAnnotatedMethod() {
		expect(halLinkAnnotationRetriever.getLinksAnnotation(method)).andReturn(null);
