...
//        EasyMock.expect(variableSubstitutionController.substitution(methodPageable, 0, "page", pageable)).andReturn(true);
  //      EasyMock.expect(pageable.getPageNumber()).andReturn(1);
 //       EasyMock.expect(uriTemplate.set("page", 1)).andReturn(uriTemplate);

//        EasyMock.expect(variableSubstitutionController.substitution(methodPageable, 0, "size", pageable)).andReturn(true);
//        EasyMock.expect(pageable.getPageSize()).andReturn(2);
//        EasyMock.expect(uriTemplate.set("size", 2)).andReturn(uriTemplate);

//        EasyMock.expect(variableSubstitutionController.substitution(methodPageable, 0, "sort", pageable)).andReturn(true);
...
//        EasyMock.expect(variableSubstitutionController.substitution(methodPageable, 0, "page", pageable)).andReturn(false);
//        EasyMock.expect(variableSubstitutionController.substitution(methodPageable, 0, "size", pageable)).andReturn(false);
//        EasyMock.expect(variableSubstitutionController.substitution(methodPageable, 0, "sort", pageable)).andReturn(false);
